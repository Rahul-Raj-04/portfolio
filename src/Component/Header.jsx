function Header() {
  return (
    <div>
      <header className="pb-6 bg-[#1f242d] lg:pb-0  text-white  fixed z-100 top-0 w-full">
        <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
          <nav className="flex items-center justify-between h-16 lg:h-20">
            <div className="flex-shrink-0">
              <div className="w-[50px] h-8 lg:h-10 text-white text-3xl">
                PORTFOLIO
              </div>
            </div>
          ...
          {/* <!-- xs to lg --> */}
          <nav className="pt-4 pb-6 bg-[#1f242d] border border-gray-200 rounded-md shadow-md lg:hidden">
